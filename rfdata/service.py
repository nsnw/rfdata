...
class APRSClient(asyncio.Protocol):
        ...
        try:
            ...
            # Check for message packets
                ...
                if packet.message_id:
                    self.send_message(packet.source, "ack{}".format(packet.message_id))
    ...
    async def get_qrz(self, callsign):
        ...
        async with aiohttp.ClientSession() as session:
            async with session.get(
                "https://qrz-api.dokku.vm.de.nsnw.ca/short/{}".format(callsign)
            ) as response:
    ...
    def send_message(self, destination, message, ack=None):
        ...
        for message in messages:
            ...
            # Log command
            self.log_command(destination, message, True)
